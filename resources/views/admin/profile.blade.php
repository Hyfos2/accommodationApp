...
<div  class="col-md-12" style="height:35px; background-color:white; top:70px;">
    ...
    <ul class="nav navbar-left" style="float:left;">
            ...
            <div class="card" style="width:100%;">
                ...
                <ul class="list-group list-group-flush">
                    <div class="nav flex-column nav" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">User Details</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">User Details</div>
